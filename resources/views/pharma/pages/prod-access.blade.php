...
@section('content')
    <div class="banner">
        <div class="col-lg-12 d-flex">
            <div class="row">
                {{-- <div class="col-lg-3 filter-products container">
                    <div class="filter-block">
                        <form action="">
                            <div class="criteria-list">
                                <p>SUBSTANCES ACTIVES </p>
                                <div class="search me-3 d-flex justfy-content-between align-items-center">

                                    <select class="form-select form-control input-search-sm"
                                        aria-label="Default select example">
                                        <option selected>Tous</option>
                                        <option value="1"> Amino </option>
                                        <option value="2"> Beta </option>
                                        <option value="3"> acide folique </option>
                                        <option value="4"> Papavérine </option>
                                        <option value="5"> Ibuprofène </option>
                                    </select>
                                </div>
                            </div>
                        </form>
                            ...
                            <div class="criteria-list">
                                ...
                                <div class="search me-3 d-flex justfy-content-between align-items-center">
                                    ...
                                    <select class="form-select form-control input-search-sm"
                                        aria-label="Default select example">
                                        <option selected>Tous</option>
                                        <option value="1"> Fièvres et douleurs </option>
                                        <option value="2"> Digestion</option>
                                        <option value="3"> Sommeil et Stress </option>
                                        <option value="4"> Ophtamologie</option>
                                        <option value="5"> Autres Médicaments </option>
                                    </select>
                                </div>
                            </div>
                        </form>
                            ...
                            <div class="criteria-list">
                                ...
                                <div class="search me-3 d-flex justfy-content-between align-items-center">
                                    ...
                                    <select class="form-select form-control input-search-sm"
                                        aria-label="Default select example">
                                        <option selected>Tous</option>
                                        <option value="1"> Shalina </option>
                                        <option value="2"> ACTM </option>
                                        <option value="3"> Labo Pharma </option>
